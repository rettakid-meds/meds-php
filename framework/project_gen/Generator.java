...
/**
 * Created by Lwazi Prusent on 2015/08/25.
 */
public class Generator {

    private static String schemeFilepath = "C:\\Development\\Servers\\wamp\\www\\pacs\\protected\\persistence\\scheme.sql";
    ...
    private static class PhpGenerator {
        ...
        private String getFileText() {
            String fullText = "";
            try (BufferedReader br = new BufferedReader(new FileReader(schemeFilepath))) {
